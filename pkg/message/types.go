...
type Stats struct {
	...
	DuplicatePrefixes                      uint32 `json:"duplicate_prefix,omitempty"`
	...
	ExperimentalRejectedPrefixesDueNextHop uint32 `json:"experimental_rejected_prefix_due_nexthop,omitempty"`
}
